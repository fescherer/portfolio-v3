            ...
            <label key={tool.name} className="swap swap-flip">
              ...
              <div className="swap-off relative flex h-44 w-32 items-center justify-center rounded border shadow-md ">
                <div className="flex flex-col items-center gap-2 text-center">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="absolute -right-1 -top-1 size-4 rounded-full  bg-base-content text-base-100">
              ...
              <div className="swap-on relative flex h-44 w-32 flex-col items-center rounded border p-2 shadow-md">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="absolute -right-1 -top-1 size-4 rounded-full border border-base-content bg-base-100 p-0.5 text-base-content">
